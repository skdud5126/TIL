...
- `CSS Box Model` : 웹 페이지의 모드 HTML 요소를 감싸는 사각형 상자 모델
    - 내용(content), 안쪽 여백(padding), 테두리(border), 외부 간격(margin)으르 구성되어 요소의 크기와 배치를 결정
...
- flex-basis와 width 값을 동시에 적용한 경우 flex-bisis가 우선
